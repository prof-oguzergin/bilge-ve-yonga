...
**Seri:** Bilgisayar Mimarisi Serisi — Alt Seri 1: Kumdan Bilgisayara — Kitap 1.1c
**Yaş grubu:** 7–10 (okuma bilen)
**Ana tema:** Transistör anahtarlarından mantık kapıları kurmak: VE, VEYA, DEĞİL
...
## Sayfa 2 — İkisi Birden

**Metin:**
Bilge iki düğmeye birden bastı.
...
## Sayfa 4 — Yan Yana Koyunca

**Metin:**
Yonga anahtarların bağlantısını değiştirdi. Şimdi ikisi yan yanaydı.

Bilge yalnız birinci düğmeye bastı. Lamba yandı.

Yalnız ikinciye bastı. Lamba yine yandı.
...
## Sayfa 7 — Bu Anahtarlar Tanıdık

**Metin:**
{Y}"Şimdi asıl sırrı söyleyeyim." dedi Yonga. {Y}"Bu düğmelerin yerinde bilgisayarda ne var, biliyor musun?"
...
{B}"Bunu yapan bir lamba kurabilir miyim?" diye sordu.

{Y}"Kurabilirsin." dedi Yonga. {Y}"Mühendisler de tam böyle başlar: önce kâğıtta, sonra yongada."

**Resim:**
Bilge masasında, defterine iki kutu çizmiş; birinci kutunun çıkışından ikinci kutunun girişine bir ok gidiyor, birinci kutuya soldan gelen okun ucu ise kalemin ucundan başlıyor. Yonga defterin üstünde süzülüp çizime bakıyor. Masada devre tahtası ve sönük ampul duruyor.
...
**Resim:**
Gece odası. Masadaki lamba yanık, Bilge elini düğmenin üstünde tutuyor ve gülümsüyor. Yonga'nın gövdesinde iki küçük ışık sırayla yanıp sönüyor. Pencerede yıldızlar var.
