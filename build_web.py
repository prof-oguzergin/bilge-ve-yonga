...
.mz{position:fixed;right:14px;top:74px;z-index:60;display:flex;
  align-items:center;gap:8px;padding:8px 12px 8px 10px;border-radius:999px;
  background:rgba(18,26,60,.92);border:1px solid rgba(150,190,240,.55);
  backdrop-filter:blur(6px);box-shadow:0 12px 30px -12px #000}
