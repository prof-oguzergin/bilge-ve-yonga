...
function deneHarf(kap){
  // Harfler iki karakterin adindan: Bilge ve Yonga. Yinelenenler bir kez
  // yazilir. Buyuk ve kucuk harf oldugu gibi durur, cunku ikisinin sayisi
  // farklidir; cocuk buna da carpar.
  const HARFLER = ['B','i','l','g','e','Y','o','n','a'];
