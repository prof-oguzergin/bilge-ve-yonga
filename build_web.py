...
.dene-yonerge{margin:0 0 12px; font-size:.94rem; color:var(--kagit-solgun); text-align:center}
...
.dene-sonuc{text-align:center; margin:12px 0 0; font-family:var(--ff-disp);
  font-size:1.35rem; color:var(--kagit-koyu)}
.dene-esit{color:var(--kagit-solgun)}
