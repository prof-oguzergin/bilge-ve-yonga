...
.yanit{margin-top:26px; border-top:2px solid var(--edge); padding-top:16px}
.yanit summary{cursor:pointer; font-family:var(--ff-disp); font-weight:800;
  color:var(--amber); font-size:1rem; list-style:none; display:inline-flex;
...
.yanit summary:hover{background:color-mix(in srgb,var(--amber) 12%,transparent)}
