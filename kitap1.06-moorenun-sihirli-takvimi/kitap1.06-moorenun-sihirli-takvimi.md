...
**Seri:** Bilgisayar Mimarisi Serisi — Alt Seri 1: Kumdan Bilgisayara — Kitap 1.6
**Yaş grubu:** 7–10 (okuma bilen)
**Ana tema:** Moore Yasası: transistörlerin her iki yılda bir ikiye katlanması
...
**Metin:**
{Y}"Bu takvim sana bir şeyi hatırlatıyor mu?" diye sordu Yonga. Bilge elindeki hesap makinesine baktı: {B}"Büyükannemin bu koca hesap makinesi ile benim tabletim çok farklı görünüyor. Neden acaba?" Yonga gülümseyerek dedi: {Y}"Çünkü bilgisayarlar da tıpkı bu takvim gibi büyüyüp güçleniyor! Sana göstereyim."
...
## Sayfa 3 — Gordon Moore Kim?

**Metin:**
Yonga anlattı: {Y}"Çok zeki bir adam vardı, adı Gordon Moore. Adı M-O-O-R-E diye yazılır." Bilge harfleri birleştirdi: {B}"Mo-o-re mi?" Yonga güldü: {Y}"Hayır, İngilizce bir ad bu, 'Mur' diye okunur! Bu Mur amca 1965 yılında çok önemli bir şey fark etti." Bilge heyecanla sordu: {B}"Ne fark etti?"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Yonga, küçük bir hologram ekranında gözlüklü, güler yüzlü yaşlıca bir adamın karikatürünü gösteriyor — Gordon Moore'un sevimli, çizgi film tarzı portresi. Bilge meraklı gözlerle hologramı inceliyor, parmağını yanağına koymuş düşünür gibi duruyor. Arka planda eski fotoğraflar ve rozetlerle dolu anı panosu gibi bir duvar var, 1960'lar havasında sepia tonlar ve canlı renkler karışık.

---

## Sayfa 4 — İki Yılda İki Kat

**Metin:**
{Y}"Her iki yılda bir, bir yonganın içindeki transistör sayısı ikiye katlanıyor!" dedi Yonga. {Y}"Buna Moore Yasası denir." Bilge'nin gözleri parladı: {B}"Transistörler! Hani şu milyarlarca küçük anahtar! Küçülüp aralarında gezmiştik!" Sonra şaşırdı: {B}"Peki her iki yılda bir bilgisayarlar iki kat daha güçlü mü oluyor?" Yonga başını salladı: {Y}"Tam olarak öyle değil ama genelde evet, bilgisayarlar daha hızlı ve daha yetenekli oluyor!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Büyük bir takvim sayfası ön planda; sayfanın sol yarısında küçük transistörlerin sayısı gösteriliyor — önce 2, sonra 4, sonra 8, sonra 16. Her sayı altın rengi daireler içinde yazılı. Bilge parmaklarıyla saymaya çalışıyor, Yonga heyecanla kollarını sallıyor. Sıcak sarı, turuncu ve mavi tonlar; büyüme ve heyecan hissi.
...
**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Yonga takvim sayfalarını hızla çeviriyor; her sayfadan fırlayan nokta bulutları büyüyüp büyüyüp odayı doldurmaya başlıyor. Bilge parmak hesabı yapmaya çalışıyor ama sayılar o kadar büyük ki elleri üzerinde yetmiyor — gülümseyen şaşkın bir ifadeyle etrafındaki nokta bulutuna bakıyor. Canlı mavi, altın ve beyaz tonlar; sayıların büyümesinin görsel şenliği.

---

## Sayfa 7 — Milyarlara Ulaştı

**Metin:**
{Y}"Bugün bir yonganın içinde milyarlarca transistör var!" dedi Yonga. Bilge şaşkınlıktan ağzını elleriyle kapattı: {B}"Benim tabletimin içinde de mi bu kadar çok var?" {Y}"Evet! Hepsi tırnak kadar küçük bir yonganın içinde. Transistörler küçüldükçe aynı yere daha çoğu sığıyor!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Yonga, avucunda küçük bir yonga tutuyor; yonganın üzerinden milyarlarca küçük ışık noktası yayılarak odanın tavanına kadar ulaşıyor — gece gökyüzündeki yıldızlar gibi. Bilge elleriyle ağzını kapatmış, gözleri faltaşı gibi açılmış. Arka planda koyu mavi bir uzay görüntüsü gibi arka plan, yonga ise altın ışıltısıyla parlıyor. Dramatik, büyülü ve şaşırtıcı bir sahne.
...
## Sayfa 9 — Takvimin Sihri Devam Ediyor mu?
...
## Sayfa 10 — Sınırın Ötesi

**Metin:**
{Y}"Transistörün içindeki en ince katman artık yalnızca birkaç atom kalınlığında!" dedi Yonga. {Y}"Atomlar ise çok garip davranır. Buna kuantum fiziği denir!" Bilge güldü: {B}"Bilgisayarlar da bazen şaşırıyor mu?" Yonga başını salladı: {Y}"Bazen! O kadar küçük yerde elektrik sızabilir, sıfır ile bir birbirine karışabilir. Mühendisler bunu önlemek için çok uğraşıyor."

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Yonga, minik bir hologramda bir transistörün atom boyutuna ulaşmasını gösteriyor; etrafında küçük atomlar dans ediyor gibi. Bilge bu görüntüye bakarak gülerek "şaşırdı" ifadesiyle ellerini açmış. Arka planda soyut, rengarenk kuantum dalgaları gibi soyut görseller var. Canlı mor, mavi ve altın tonlar; bilinmezin eğlenceli tarafını vurguluyor.
...
**Metin:**
Bilge tekrar büyükannesinin evinde oturuyordu. Takvimi ve eski hesap makinesini yan yana koydu, sonra kendi tabletine baktı. {B}"Belki ben büyüyünce transistörlerden daha akıllı bir şey icat ederim!" dedi. Yonga parladı: {Y}"Eminim yaparsın, Bilge!"
...
🗓️ **Moore Yasası** ("Mur" diye okunur): Bir yonganın içindeki transistör sayısı her iki yılda bir ikiye katlanır!
...
⚛️ Artık transistörler **atom boyutuna** yaklaşıyor, daha da küçültmek çok zorlaştı.
