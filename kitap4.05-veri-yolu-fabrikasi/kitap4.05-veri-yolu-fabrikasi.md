...
**Metin:**
{B}"Yonga, buyrukları öğrendim, yazmaçları öğrendim, AMB'nin nasıl topladığını da öğrendim." dedi Bilge. {B}"Ama hâlâ bütün bu parçalar bir araya gelince nasıl çalışıyor, onu bilmiyorum."
...
## Sayfa 3 — Yol Gösteren Yazmaç

**Metin:**
{Y}"Program Sayacı'nı hatırlıyor musun?" diye sordu Yonga. {Y}"Buyrukları öğrenirken görmüştük."

{B}"Evet!" dedi Bilge. {B}"Şu an neredeyiz, sıradaki buyruk nerede diyen özel yazmaç."

{Y}"Aynen öyle." dedi Yonga. {Y}"Fabrikamızda Program Sayacı, buyruk belleğine bana şu adresteki buyruğu ver diye işaret eden bir yol göstericidir."

**Resim:**
Fabrikanın en başında küçük, parlak bir işaret levhası duruyor, üzerinde "PS" yazıyor ve bir ok bir sonraki istasyona doğru uzanıyor. Bilge levhanın önünde durmuş, okun yönünü takip ediyor. Yonga levhanın üstünde oturuyor, kısa kollarıyla aynı yönü gösteriyor.
...
**Metin:**
{B}"Program Sayacı'nın işaret ettiği yerde ne var?" diye sordu Bilge.
...
## Sayfa 5 — Otuz İki Kutu Bir Arada
...
## Sayfa 6 — Hesap Ustası

**Metin:**
{Y}"Şimdi sayılar AMB'ye gidiyor." dedi Yonga. {Y}"Aritmetik Mantık Birimi'ni hatırlıyor musun? İçinde o küçük toplayıcı zinciri vardı, elde elden ele geçiyordu!"

{B}"Evet!" dedi Bilge. {B}"AMB iki sayıyı alır, toplar ya da çıkarır ya da karşılaştırır."

{Y}"Aynen öyle." dedi Yonga. {Y}"Yazmaç öbeğinden gelen iki sayı burada birleşir, tek bir sonuç çıkar."

**Resim:**
Önceki kitaptan tanıdığımız AMB kapısı, üzerinde "AMB: Aritmetik Mantık Birimi" yazan tabela. İçeri iki ince ışık teli giriyor (yazmaç öbeğinden gelen sayılar), kapının öbür ucundan tek bir kalın ışık teli çıkıyor (sonuç). Bilge kapının yanından geçen telleri takip ediyor. Yonga kapının içinde, küçük toplayıcı zincirinin çalıştığını gösteriyor.

---

## Sayfa 7 — Sayıların Deposu
...
## Sayfa 8 — Sayıların Yolculuğu

**Metin:**
{B}"Peki bütün bu istasyonlar birbirine nasıl bağlı?" diye sordu Bilge.

{Y}"Teller ile!" dedi Yonga. {Y}"Her istasyon arasında ince teller uzanır. Sayılar bu tellerin üzerinden bir istasyondan öbürüne akar, tıpkı su borularındaki su gibi."
...
## Sayfa 9 — Her İstasyonun Bir Görevi Var

**Metin:**
Bilge deftere küçük bir liste yazdı: Program Sayacı yol gösterir, buyruk belleği buyruğu verir, yazmaç öbeği sayıları verir, AMB hesaplar, veri belleği saklar ve geri verir.
...
## Sayfa 11 — Hepsi Birlikte

**Metin:**
{B}"Bütün bu istasyonlar ve teller birlikte ne oluşturuyor?" diye sordu Bilge.

{Y}"Buna **veri yolu** denir." dedi Yonga. {Y}"Program Sayacı, buyruk belleği, yazmaç öbeği, AMB, veri belleği ve onları bağlayan bütün teller, hepsi birlikte veri yoludur."

{B}"Demek veri yolu işlemcinin iskeleti gibi." dedi Bilge. {B}"Bütün parçaları taşıyan omurga."

{Y}"Çok güzel benzetme!" dedi Yonga.

**Resim:**
Bütün fabrika artık tek, bütünleşmiş bir makine gibi görünüyor, beş istasyon ve aralarındaki teller birlikte bir insan iskeletine benzer bir şekil oluşturuyor, üzerinde "VERİ YOLU" yazan büyük bir tabela parlıyor. Bilge geriye adım atmış, bütün resmi hayranlıkla izliyor. Yonga onun yanında aynı gururlu ifadeyle duruyor.
...
**Resim:**
Bütün fabrika aynı anda çalışırken görünüyor, her istasyon parlak ışıklarla titreşiyor, teller boyunca hızlı ışık akışları var. Bilge kulaklarını hafifçe tıkamış gibi ama gözleri büyük bir hayranlıkla parlıyor, fabrikanın tam ortasında duruyor. Yonga büyük kırmızı düğmenin yanında, kolunu havaya kaldırmış zafer kazanmış gibi duruyor.

---

## Sayfa 13 — Bir Buyruğun Yolculuğu
...
**Resim:**
Fabrikanın girişinde bir kapı beliriyor, üzerinde "Bir Sonraki Durak: Buyruğun Yolculuğu" yazıyor. Kapının aralığından, tek bir parlak buyruk kartının fabrikanın içinde ilerlediği hayal edilir gibi bir ışık huzmesi görünüyor. Bilge kapıyı meraklı gözlerle aralıyor. Yonga yanında heyecanla zıplıyor, ışıklarını hızlı hızlı yakıp söndürüyor.

---

## Sayfa 14 — Fabrika Gece de Çalışıyor

**Metin:**
O gece Bilge yatağına uzandı ve gözlerini kapattı.

{B}"Şu an, bu odada, bilgisayarımda küçük bir fabrika var." diye düşündü. {B}"Program Sayacı yol gösteriyor, buyruk belleği buyruk veriyor, yazmaç öbeği sayıları paylaşıyor, AMB hesaplıyor, veri belleği saklıyor. Hepsi tellerle bağlı, hepsi birlikte tek bir veri yolu."

Gülümseyerek derin bir uykuya daldı.

**Resim:**
Gece sahnesi: Bilge yatağında uyuyor, oda karanlık ve sakin. Masasındaki bilgisayar ekranı hafifçe parlıyor, ekranın içinde minyatür bir fabrika sahnesi görünüyor, beş istasyon ışıl ışıl çalışıyor, teller boyunca küçük ışık noktaları akıyor. Yonga pencere kenarında oturmuş, ekrandaki fabrikayı sevgiyle izliyor, karnındaki ışık yumuşak bir mavi tonla parlıyor.
