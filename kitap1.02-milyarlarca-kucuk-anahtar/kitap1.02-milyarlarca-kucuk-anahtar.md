...
## Sayfa 5 — Küçülme Zamanı!

**Metin:**
{Y}"Hadi o küçük anahtarları görelim!" dedi Yonga. Düğmeye bastı ve ikisi de küçücük oldu. Artık bir karıncadan bile küçüklerdi!

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bilge ve Yonga küçülürken etrafları mavi-mor spiral ışık sarıyor; altlarında normal büyüklükteki masa ve sandalye dev görünüyor. Bilge keyifle gülerek kollarını açmış, saçları yukarı uçuşuyor. Yonga dönerek ışık saçıyor. Arka planda odanın tanıdık mobilyaları dev boyutlara büyümüş. Koyu mavi-mor ve açık sarı tonlar; eğlenceli küçülme sahnesi, Alice Harikalar Diyarı'nı anımsatan coşkulu bir atmosfer.
...
**Metin:**
Yonga anlattı: {Y}"Kapalı anahtar '0' demek. Açık anahtar '1' demek. Bilgisayarlar sadece 0 ve 1 bilir!" {Y}"Bir tek 0 ya da bir tek 1'e **bit** denir; bilgisayarın en küçük bilgi parçası odur." Bilge düşündü: {B}"Sadece iki şey mi?"
...
**Metin:**
{Y}"Harfler de 0 ve 1'den yapılır!" dedi Yonga. Her harf için sekiz haneli bir 0-1 dizisi kullanılır; sekiz bitlik böyle bir öbeğe **bayt** denir. Büyük 'A' harfi 01000001'dir. Hangi harfin hangi sayıyla yazıldığını söyleyen listenin adı **ASCII**'dir. Bilgisayar harfleri görmez, sadece 0 ve 1 görür!
...
1️⃣ Bir tek 0 ya da bir tek 1'e **bit** denir; bilgisayarın en küçük bilgi parçasıdır.

8️⃣ Sekiz bit bir arada durursa ona **bayt** denir; bir harf tam bir bayta sığar.
