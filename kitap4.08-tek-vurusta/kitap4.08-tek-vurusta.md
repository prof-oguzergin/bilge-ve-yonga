...
**Seri:** Bilgisayar Mimarisi Serisi — Alt Seri 4: İşlemcinin İçi — Kitap 4.8
**Yaş grubu:** 9–12 (okuma bilen)
**Ana tema:** En basit işlemci tasarımında her buyruk tam bir saat vuruşunda başlar ve biter, ama vuruşun uzunluğu en yavaş buyruğa göre ayarlanır ve hızlı buyruklar boşuna bekler.
...
{Y}"Hiçbiri!" dedi Yonga. {Y}"Vuruş bitmeden buyruk da tamamlanmış oluyor. Buna tek vuruşluk veri yolu denir."

**Resim:**
Yonga'nın göğüs ekranında parlak bir zaman çizgisi beliriyor; tek bir kutu üzerinde "1 VURUŞ = 1 BUYRUK" yazıyor, kutunun başında ve sonunda küçük bayraklar var. Bilge ekrana burnu değecek kadar yaklaşmış, hayranlıkla izliyor. Atölyenin arka planında duvar saati hâlâ sallanıyor.
...
**Resim:**
Küçük bir koridor çizimi, üzerinde yedi kapı, her kapıda kendi simgesi (zarf, büyüteç, açık çekmece, dişli amblemi, raf, çekmeceye giren ok, sağa ok). Minik ışıklı bir buyruk simgesi bütün kapılardan aynı anda geçiyormuş gibi hızlı bir çizgiyle gösteriliyor, en üstte büyük bir saat sembolü tek bir vuruş çerçevesini sarıyor. Bilge parmağıyla koridoru baştan sona takip ediyor.

---

## Sayfa 4 — Vuruş Ne Kadar Sürer?

**Metin:**
{B}"Peki bir vuruş ne kadar sürüyor?" diye sordu Bilge.

Yonga düşündü. {Y}"İyi soru. Bazı buyruklar çok çabuk biter, bazıları daha uzun sürer. Ama tek vuruşluk tasarımda hepsine aynı süre ayrılır."

Bilge kaşlarını çattı. {B}"Aynı süre mi? Hızlı olan da mı bekler?"

**Resim:**
Yonga'nın ekranında iki farklı buyruk simgesi yan yana; biri küçük ve hafif (toplama), öbürü büyük ve ağır (bellekten okuma), ikisinin de altında eşit uzunlukta bir zaman çubuğu var. Bilge çubuklara bakıp kafasını kaşıyor, meraklı bir ifadeyle.
...
**Metin:**
Yonga bir anı hatırlattı. {Y}"Geçen hafta okul gezisinde ormanda yürüdünüz, hatırlıyor musun?"
...
**Resim:**
Aynı orman patikasında yakın çekim; önde hızlı yürüyen birkaç çocuk durmuş bekliyor, arkada yorgun bir çocuk zorlukla yürüyor, öğretmen ona yardım eli uzatıyor. Bilge bu sahneyi hayalinde canlandırıyor, elini çenesine götürmüş düşünceli bir ifadeyle.

---

## Sayfa 7 — Kısa Buyruk, Uzun Buyruk
...
**Resim:**
Yonga'nın ekranında iki karşılaştırmalı simge: hızlı koşan minik bir artı işareti ile ağır ağır ilerleyen bir bellek kutusu simgesi arasında bir yarış pisti çizimi. Bilge gülerek parmağını hızlı simgeye doğru uzatıyor.

---

## Sayfa 8 — Saat, En Yavaşa Göre Ayarlanır
...
## Sayfa 12 — Saati Sonsuza Kadar Hızlandıramayız
...
## Sayfa 13 — Daha Akıllı Bir Yol Var mı?
...
⏱️ **Tek vuruşluk veri yolu**, her buyruğun tam bir saat vuruşunda başlayıp bittiği en basit işlemci tasarımıdır.
...
🔮 İşi küçük adımlara bölerek bu bekleyişi azaltmanın bir yolu vardır; onu birlikte öğreneceğiz.
