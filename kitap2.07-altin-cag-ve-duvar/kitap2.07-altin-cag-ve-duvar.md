...
## Sayfa 1 — Garajdaki Eski Gazeteler

**Metin:**
Bilge ve Yonga, dedesinin garajında eski gazeteler buldu. Sararmış sayfalarda "Yeni Araba Rekoru: Her Yıl Daha Hızlı!" başlıkları göze çarpıyordu. {B}"Bu haberler her yıl mı çıkıyordu?" diye sordu Bilge hayretle. Yonga başını salladı: {Y}"Bilgisayarlar için de böyleydi. O zamanlar neredeyse iki yılda bir hızları iki katına çıkıyordu!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Ahşap raflı, sıcak ışıklı eski bir garaj. Bilge yere oturmuş sararmış gazeteler karıştırıyor; gazete manşetlerinde "2x Daha Hızlı!" ve "Rekor Kırıldı!" başlıkları görünüyor. Yonga yanında oturmuş, ekranında küçük bir grafik gösteriyor: birkaç yılda bir iki katına çıkan çubuklar. Arka planda dedeye ait araç parçaları asılı.
...
**Metin:**
{B}"Bu nasıl mümkün oldu?" diye sordu Bilge. Yonga anlatmaya başladı: {Y}"Uzun zaman önce, 1980'lerde, mühendisler her yıl yongalara biraz daha küçük parçalar sığdırmayı başardılar." {Y}"Parçalar küçüldükçe yongaya daha çoğu sığıyor, hepsi de daha hızlı çalışıyordu." Bilge gözlerini kırptı: {B}"Her yıl biraz mı?" {Y}"Her yıl biraz." dedi Yonga. {Y}"Ama biriktikçe birikti. İki yılda bir bilgisayarların hızı ikiye katlanıyordu. Bu döneme **altın çağ** deriz."
...
**Metin:**
{B}"Bu duvar ne zaman belirdi?" diye sordu Bilge. {Y}"2004 ve 2005 yıllarında." dedi Yonga. {Y}"Mühendisler saat vuruş sıklığını daha fazla artıramayacaklarını fark etti. Yongalar o kadar ısınıyordu ki eriyip bozulabilirdi." Bilge içini çekti: {B}"O zaman yıllar boyu sürüp giden hız artışı durdu mu?" {Y}"Neredeyse durdu." dedi Yonga.
...
## Sayfa 6 — Yeni Bir Yol

**Metin:**
Bilge üzüldü. {B}"Bu demek oluyor ki bilgisayarlar artık hiç hızlanamaz mı?" Yonga güldü: {Y}"Hayır! Mühendisler çok akıllıydı, farklı bir yol buldular." Bilge merakla öne eğildi. {B}"Anlat!" dedi. {Y}"Tek hızlı araba yerine birden fazla araba yan yana koşturdular. Birlikte çok daha fazla iş yapabiliyorlardı!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bir pistte önce tek bir araba var; duvarla karşılaşıyor ve duruyor. Sonra pistin yanında yeni bir bölüm açılıyor: iki araba yan yana koşuyor, ardından dört araba. Her gruplamada altında "2 çekirdek", "4 çekirdek" yazıyor. Yonga ellerini açmış "işte bu!" diyormuş gibi gülümsüyor.

---

## Sayfa 7 — Çok Çekirdekli İşlemci

**Metin:**
{B}"Bu çok zekice!" dedi Bilge. {B}"Bir araba yetmiyorsa iki araba kullanırsın!" Yonga başını salladı: {Y}"Bilgisayarlarda buna **çok çekirdekli** işlemci diyoruz. Her çekirdek ayrı bir küçük motor gibidir, birlikte çalışırlar." Bilge sordu: {B}"Bugünkü bilgisayarlarda kaç çekirdek var?" {Y}"Çoğunda 4, 8, hatta 16!" dedi Yonga.

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Büyük bir bilgisayar yongası çizimi; içinde yan yana duran dört renkli küçük araba motoru görünüyor. Her motorun üstünde "Çekirdek 1", "Çekirdek 2", "Çekirdek 3", "Çekirdek 4" yazıyor. Bilge eliyle yongayı işaret ediyor, Yonga yanında onaylayarak başını sallıyor.
...
## Sayfa 14 — Yeni Bir Sabah

**Metin:**
Sabah uyandığında Bilge her şeyi annesine anlattı. Annesi güldü: {D}"Telefonda oyun oynarken dört çekirdek çalışıyor demek!" {B}"Evet, dördü birlikte çalışıyor!" dedi Bilge. Yonga kapı aralığından başını uzattı: {Y}"Bugün de öğrenecek çok şey var, Bilge." Yeni bir macera başlamıştı.

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Sabah güneşi dolan mutfak; Bilge kahvaltı masasında annesine anlatıyor, ellerini heyecanla kullanıyor. Annenin elinde akıllı telefon var; telefon üstünde Bilge'nin eklediği hayal baloncuğu ile dört küçük koşan araba görünüyor. Yonga mutfak kapısından gülümseyen gözlerle bakıyor.
