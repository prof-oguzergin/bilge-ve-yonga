...
## Sayfa 1 — Sen Hep Var mıydın?

**Metin:**
Bilge yatağına uzanmış tavana bakıyordu.

{B}"Yonga, sen hep var mıydın?" diye sordu.
...
## Sayfa 2 — Parmaklar Yetmeyince

**Metin:**
{Y}"En başta insanlar parmaklarıyla sayıyordu." dedi Yonga. {Y}"Ama sürüler büyüdü, alışverişler çoğaldı, parmaklar yetmedi."
...
## Sayfa 3 — Babasına Yardım Etmek İsteyen Çocuk

**Metin:**
{Y}"1642 yılında Blaise Pascal adında biri, bilinen anlamda ilk mekanik hesap makinesini tasarladı." dedi Yonga.
...
## Sayfa 5 — Delikli Kartlar

**Metin:**
{Y}"1890 yılında Herman Hollerith delikli kartlarla çalışan bir düzenek geliştirdi." dedi Yonga.
...
**Resim:**
Terazi gibi bir karşılaştırma: solda kocaman bir cam vakum tüpü, sağda onun yanında minicik duran bir transistör. Solda ısı dalgaları çiziliyor, sağda serinlik. Bilge küçük olanı parmak uçlarında tutmuş inceliyor. Yonga yanında süzülüyor.
...
**Resim:**
Yakın plan bir yonga yüzeyi; ince çizgiler bir şehrin yollarına benziyor, aralarında küçük kare parçalar var. Sol üst köşede eski bir devre kartı görünüyor, üstünde ayrı ayrı duran iri parçalar var; ikisi arasında bir karşılaştırma oku duruyor. Bilge büyüteçle bakıyor.

---

## Sayfa 13 — Hepsi Tek Yongada

**Metin:**
{Y}"1971 yılında Intel'in 4004 yongası çıktı." dedi Yonga. {Y}"İşlemcinin bütün parçaları ilk kez tek bir tümleşik devrede toplandı. İlk mikroişlemci."
...
**Resim:**
Karanlık oda, yatağında uyuyan Bilge. Yonga usulca yanında süzülüyor, ışığı kısılmış. Havada, rüya gibi yumuşak bir çizgide iki şekil yan yana: solda kocaman eski bir makine, sağda minicik bir yonga; ikisi arasında ince bir ışık çizgisi var. Huzurlu, sıcak bir kapanış.
...
⚙️ 1642 yılında Blaise Pascal, toplama ve çıkarma yapabilen ilk mekanik hesap makinesini tasarladı; babasına yardım etmek istiyordu.

🕳️ 1890 yılında Hollerith'in **delikli kartları** ile bütün bir ülkenin nüfusu sayıldı.
