...
## Sayfa 1 — Dünkü Ders Hâlâ Aklında
...
Yonga gülümsedi. {Y}"Var! Bugün sana tam da onu göstereceğim."

**Resim:** Güneşli bir mutfak, kahvaltı masası. Bilge sandalyede oturmuş elinde bir kaşık, düşünceli bir ifadeyle Yonga'ya bakıyor. Yonga masanın kenarında havada süzülüyor, gövdesinin alt bölümündeki küçük ekranda soluk bir saat çarkı simgesi yanıp sönüyor. Masada kahvaltılık tabaklar, sıcak bir ev atmosferi.
...
**Resim:** Masada buharı tüten bir çorba kâsesi, yanında küçük bir kaşık. Bilge kaşığı kâseye daldırmış, küçük bir kaşık dolusu çorba almış, ağzına götürmek üzere. Yonga yanında, havaya yansıttığı hologramda kâseyi küçük dilimlere ayıran bir çizim beliriyor. Sıcak, samimi bir sabah ışığı.
...
**Resim:** Yonga'nın havaya yansıttığı hologramda yavaşça yanıp sönen küçük bir saat simgesi ve altında yan yana üç küçük ışık noktası beliriyor. Bilge masaya parmağıyla ritim tutuyor, gözleri ekrandaki saate kilitlenmiş. Arka planda duvar saatinin sarkacı da aynı ritimde sallanıyor.
...
**Resim:** Yonga'nın havaya yansıttığı hologramda üç küçük kutu art arda duruyor; kutuların üstünde sırasıyla zarf, büyüteç ve dişli amblemi var, aralarında kısa oklar bulunuyor. Bilge elleriyle üç parmağını gösteriyor, "sadece üç adım" der gibi. Ekranın kenarında küçük bir çorba kâsesi ikonu, neredeyse boşalmış.

---

## Sayfa 5 — Uzun Buyruk, Çok Tık
...
## Sayfa 7 — Aynı Parçayı İki Kere Kullanmak

**Metin:**
{B}"Yonga, o toplama işini yapan alet her adımda mı çalışıyor?" diye sordu Bilge.
...
**Resim:** Yonga'nın ekranında ortada duran küçük bir "AMB" kutusu, ona farklı adımlardan gelen iki ayrı ok bağlanıyor. Bilge elinde tuttuğu tek bir kaşığı önce çorba kâsesine, sonra hayal balonunda bir tatlı kâsesine daldırıyor gibi gösteriliyor. Neşeli, keşfeden bir ifade.

---

## Sayfa 8 — Az Donanım, Çok İş
...
**Resim:** Şef figürü artık dört farklı bayrağı sırayla kaldırıyor, alnında küçük bir ter damlası var ama gülümsüyor. Bilge onu izlerken elini çenesine götürmüş, düşünceli bir ifadeyle "her şeyin bedeli var" der gibi bakıyor.
...
**Resim:** Bir masada tek bir çorba kâsesi duruyor, Bilge onu kaşık kaşık bitiriyor, yanındaki ikinci kâse henüz kapalı bir kapağın altında bekliyor. Yonga elini kapağın üzerine koymuş, "sırası gelince" der gibi bir ifadeyle bekletiyor.

---

## Sayfa 12 — Tabağını Bitirmeden Yenisi Başlamaz

**Metin:**
Bilge kâsesini bitirdi, kaşığını masaya bıraktı. {B}"Tamam, ben bitirdim. Şimdi ikinci kâse gelebilir mi?"

{Y}"Şimdi gelebilir!" dedi Yonga ve ikinci kâseyi masaya koydu. {Y}"Görüyor musun? Bir iş tamamen bitmeden öbürü başlamıyor. Yalnızca her işin kendi içi artık kısa kısa adımlara bölünmüş durumda."
...
## Sayfa 14 — Adım Adım İlerlemeye Devam
...
🎛️ Bu yöntem daha verimlidir ama **denetim** daha karmaşıklaşır, çünkü şefin her adımda ayrı bir işaret vermesi gerekir.
