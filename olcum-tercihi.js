...
(function () {
  ...
  function stilEkle() {
    ...
    s.textContent = [
      ...
      '  font-size:16px;line-height:1.6;padding:16px clamp(16px,3vw,32px)}',
      ...
      '#bvy-olcum .bvy-metin{flex:1 1 380px;min-width:0;max-height:38vh;',
      '  overflow-y:auto;overscroll-behavior:contain}',
      '#bvy-olcum h2{margin:0 0 6px;font-size:1.02rem;font-weight:800;',
      '  font-family:var(--font-display,inherit);line-height:1.25}',
      '#bvy-olcum p{margin:0 0 4px}',
  ...
  function bildirimGoster() {
    ...
    d.innerHTML = [
      ...
      '    <p>Burada hesap açmak, form doldurmak veya bir şey yazmak gerekmez. ',
      '    Tarayıcınıza çerez yerleştirmiyoruz.</p>',
      '    <p>Yalnızca <strong>hangi kitapların okunduğunu sayan</strong> basit bir ',
      '    ölçüm var. Bu ölçüm kim olduğunuzu kaydetmez, size reklam göstermez ve ',
      '    sizi başka sitelerde takip etmez. <strong>Şu anda kapalı.</strong></p>',
      '    <p class="bvy-kucuk">Açarsanız ziyaret bilgisi ölçüm için yurt dışındaki ',
      '    (Finlandiya/Almanya) bir sunucuya gönderilir. Açmazsanız hiçbir şey ',
      '    gönderilmez. Seçiminiz ne olursa olsun bütün kitaplara eksiksiz ',
      '    erişebilirsiniz.</p>',
      '    <p class="bvy-kucuk">Çocuklar için: Burada senden hiçbir bilgi ',
      '    istemiyoruz. İstersen hiçbir şeye dokunmadan okumaya devam edebilirsin.</p>',
      '    <p class="bvy-kucuk">Ayrıntılar: ',
      '    <a href="' + GIZLILIK + '">Gizlilik ve Çerez Politikası</a></p>',
      '  </div>',
