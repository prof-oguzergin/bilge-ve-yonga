...
Yonga yaklaştı, gözleri parladı. {Y}"Bilge, sen az önce bir buyruğun işlemci içindeki yolculuğunu kurmuşsun, farkında mısın?"

{B}"Bir buyruk mu tren gibi yolculuk yapıyor?" diye sordu Bilge şaşkınlıkla.

**Resim:**
Bilge'nin odasında yerde kurulu oyuncak tren rayı, üzerinde yedi minik ahşap istasyon tabelası sıralı duruyor. Bilge diz çökmüş, küçük kırmızı vagonu bir istasyondan diğerine sürüyor. Yonga yanında havada süzülüyor, göğüs ekranında minik bir tren ikonu yanıp sönüyor.
...
**Resim:**
Yonga'nın göğüs ekranında büyük harflerle "add x7, x5, x6" yazısı parlıyor, yanında küçük bir yolcu bileti ikonu var. Bilge elindeki minik kağıt bileti inceliyor, üzerinde aynı buyruk yazılı. Arka planda yedi istasyonlu tren rayı bulanık görünüyor.
...
**Resim:**
İlk istasyon tabelasında büyük harflerle "GETİR" yazıyor. Tabelanın altında ışıklı bir Program Sayacı oku bellek rafındaki bir kutucuğu işaret ediyor, kutucuktan parlak bir zarf (buyruk) çıkarılıyor. Bilge minik vagonu bu istasyona park ediyor, Yonga yanında işaret ediyor.
...
Bilge gülümsedi. {B}"Şimdi vagonda üç ile beş var!"

**Resim:**
Üçüncü istasyon tabelasında "YAZMAÇLARI OKU" yazıyor. Küçük bir yazmaç dolabı açılmış, x5 çekmecesinden "3" sayısı, x6 çekmecesinden "5" sayısı ışıklı toplar halinde çıkıp vagona biniyor. Bilge iki sayıyı elleriyle vagona koyuyor gibi bir pozda, Yonga yanında.
...
**Resim:**
Beşinci istasyon tabelasında "BELLEĞE ERİŞ" yazıyor ama peron boş ve ışıkları sönük. Vagon bu istasyonun yanından hiç durmadan geçiyor, arkasında hafif bir toz izi bırakıyor. Bilge trenin penceresinden boş peronu gösteriyor, Yonga omuz silker gibi bir ifadeyle yanında duruyor.
...
**Resim:**
Altıncı istasyon tabelasında "GERİ YAZ" yazıyor. Vagondan çıkan parlak "8" topu, x7 etiketli bir yazmaç çekmecesine düşerken gösteriliyor, çekmece hafifçe parlıyor. Bilge topu itiyor, Yonga çekmecenin dolduğunu işaret ediyor.
...
{Y}"Aferin, tam isabet!" dedi Yonga. {Y}"Bu yolcu beşinci durakta gerçekten iniyor."

Bilge yeni bir bilet çizdi. {B}"Hadi onu da takip edelim!"

**Resim:**
Yonga'nın ekranında "lw x7, 0(x5)" yazısı parlıyor. Bilge elinde yeni bir bilet tutuyor, üzerinde küçük bir bellek dolabı ikonu çizili. Arka planda yedi istasyonlu tren rayı yeniden görünüyor, bu sefer beşinci istasyonun ışıkları yanık.

---

## Sayfa 11 — Beşinci Durak Bu Kez Açık
...
**Resim:**
Altıncı istasyonda dokuz sayısı x7 çekmecesine yerleşiyor, ardından Program Sayacı tabelası bir adım kayıyor. Bilge iki yolculuğu (toplama ve yükleme) yan yana karşılaştırdığı küçük bir çizelge tutuyor, Yonga çizelgeyi onaylar gibi başını sallıyor.
...
**Resim:**
Bilge'nin odasının duvarına astığı büyük bir çizelge, üzerinde yedi istasyon sırayla resimli: zarf, büyüteç, yazmaç çekmecesi, AMB makinesi, bellek rafı, yazmaç çekmecesi ve ilerleyen Program Sayacı oku. Bilge çizelgenin önünde gururla duruyor, Yonga yanında ışıklarını mutlulukla yakıp söndürüyor.
...
🗄️ **Belleğe Eriş**: yalnızca yükleme ve saklama buyruklarında kullanılır, toplama gibi buyruklar bu durağı atlar.
