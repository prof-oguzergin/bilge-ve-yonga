...
## Sayfa 1 — Bir Buyruğun İçi

**Metin:**
Bilge geçen gün öğrendiği adımları hatırladı.

{B}"Bir toplama buyruğu dört tıkta bitiyordu, değil mi?" dedi. {B}"Getir, çöz, yürüt, geri yaz."

Yonga başını salladı. {Y}"Doğru hatırlıyorsun. Ama bugün sana bir sır vereceğim. O adımların her biri de kendi içinde daha minik parçalardan oluşuyor!"

Bilge gözlerini kocaman açtı. {B}"Adımların içinde başka adımlar mı var?"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bilge ile Yonga bir hologram üzerinde dört büyük adım kutusu görüyorlar; kutuların üstünde sırasıyla zarf, büyüteç, dişli amblemi ve çekmeceye giren ok simgeleri var. Yonga parmağıyla dişli simgeli kutuya dokununca kutu yavaşça açılıyor ve içinden daha küçük, parlayan minik kutucuklar beliriyor. Bilge merakla öne eğiliyor. Sıcak turuncu ve mavi tonlar, keşif atmosferi.
...
**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Güneşli bir mutfakta dört küçük resim art arda diziliyor: yumurta kırılıyor, çırpılıyor, tavaya dökülüyor, karıştırılıyor. Bilge önlük giymiş, elinde çırpıcıyla bu adımları tek tek gösteriyor. Yonga yanında duruyor, her adımı say ile işaretliyor. Sıcak sarı, turuncu mutfak tonları.

---

## Sayfa 4 — Toplamanın Tarifi
...
## Sayfa 5 — Şefin Elindeki Tarif Defteri
...
## Sayfa 7 — Şefin Ufak Talimatları
...
## Sayfa 8 — Uzun Tarif, Kısa Tarif

**Metin:**
Yonga devam etti. {Y}"Bazı buyruklar basittir, defterdeki sayfaları kısadır. Bazı buyruklar karmaşıktır, sayfaları uzayıp gider."
...
## Sayfa 9 — Çarpmanın Uzun Yolculuğu

**Metin:**
Bilge hatırladı. {B}"Çarpma uzun sürüyordu! Her bit için ya ekliyor ya geçiyor, sonra kaydırıyordu."

{Y}"Aynen!" dedi Yonga. {Y}"Çarpma buyruğunun mikroprogramı, kaydır ve topla adımlarını bit sayısı kadar tekrarlayan uzun bir sayfadır. Toplamanın sayfası ise çok daha kısadır."

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bir tarafta uzun bir merdiven gibi uzanan basamaklarda küçük "topla, topla, topla" yazan tekrarlayan adımlar var, en tepede "çarpma bitti" yazıyor. Diğer tarafta dört basamaklı kısa bir merdiven, üstünde "toplama bitti" yazıyor. Bilge iki merdiveni karşılaştırarak bakıyor, Yonga yanında duruyor. Turuncu-mavi karşılaştırma sahnesi.
...
**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Sisko robotu elinde kalın, sayfaları taşan bir tarif kitabı tutuyor; Risko robotu elinde ince, tek sayfalık bir kartpostal tutuyor. İkisi yan yana duruyor, Bilge ve Yonga aralarında durup iki defteri karşılaştırıyor. Kırmızı-altın (Sisko) ve mavi-beyaz (Risko) tonları.

---

## Sayfa 11 — Tarifi Değiştirmek

**Metin:**
Yonga heyecanla anlattı. {Y}"En güzel yanı şu: bu defter küçük bir bellekte saklı olduğu için, mühendisler donanımı hiç değiştirmeden sayfayı güncelleyebilir."

Bilge şaşırdı. {B}"Demek bir buyrukta hata varsa, tornavidayla içeri girmeden düzeltilebiliyor?"

{Y}"Aynen öyle!" dedi Yonga. {Y}"Sadece defterin o sayfasını değiştirmek yeter."

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Şef karakteri tarif defterinin bir sayfasını silip üzerine yeni, parlak bir sayfa yapıştırıyor; arkada duran parçalar (AMB, yazmaçlar, teller) hiç değişmeden aynı kalıyor. Bilge şaşkınlıkla izliyor, elinde hayali bir tornavida tutuyor ama kullanmıyor. Yonga gülümseyerek "gerek yok" der gibi elini sallıyor.

---

## Sayfa 12 — Yeni Bir Tarif Eklemek

**Metin:**
{B}"Peki yeni bir buyruk da eklenebilir mi?" diye sordu Bilge.

{Y}"Bazen evet!" dedi Yonga. {Y}"Şefin defterine yeni bir sayfa eklenip, parçalar hiç değişmeden yeni bir iş öğretilebilir. Aynı AMB, aynı yazmaçlar, sadece yeni bir sayfa!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Şef karakteri tarif defterine yepyeni, parlayan bir sayfa ekliyor; sayfanın üstünde küçük bir yıldız işareti var. Mutfaktaki aletler (kapılar, AMB, yazmaçlar) aynı kalıyor ama şimdi yeni bir ışıkla bu yeni tarife hazırlanıyorlar. Bilge yeni sayfayı merakla okuyor, Yonga gururla gösteriyor. Parlak, umut dolu sarı tonlar.

---

## Sayfa 13 — Hepsi Bir Arada

**Metin:**
Gün batarken Bilge derin bir nefes aldı. {B}"Artık işlemcinin içini gerçekten biliyorum!"

Yonga saydı. {Y}"Hesap yapan AMB, parçaları birbirine bağlayan teller, herkese işaret veren denetim birimi, adım adım ilerleyen döngü ve her adımın içindeki minik mikro buyruklar. Hepsi birlikte çalışıyor ki bir buyruk gerçekten yaşama geçsin!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bir işlemci yongasının içi geniş bir sahne gibi açılmış; ortada AMB kutusu, etrafında veri yolu hatları, şef kıyafetli denetim birimi, yazmaç kutucukları ve minik mikro buyruk ışıkları hep birlikte uyum içinde parlıyor, tıpkı küçük bir orkestra gibi. Bilge ve Yonga bu sahneyi hayranlıkla izliyor. Sıcak, bütünlüklü altın-mavi tonlar.

---

## Sayfa 14 — Kumdan Buraya Kadar

**Metin:**
Yonga, Bilge'nin eline dokundu. {Y}"Hatırlıyor musun, en başta bir avuç kumdan başlamıştık?"
