...
**Seri:** Bilgisayar Mimarisi Serisi — Alt Seri 1: Kumdan Bilgisayara — Kitap 1.9
**Yaş grubu:** 7–10 (okuma bilen)
**Ana tema:** Güç tüketimi eğilimleri ve güç duvarı
...
## Sayfa 1 — Sıcak Bir Öğleden Sonra

**Metin:**
Bilge, bilgisayarın yanında saatlerce ders çalıştı. Sonra elini bilgisayarın altına götürdü. Orası sımsıcaktı! {B}"Yonga, bilgisayar neden bu kadar ısınıyor?" diye sordu.

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bilge ahşap masada önünde açık dizüstü bilgisayarıyla oturmuş; elini bilgisayarın alt kısmına götürmüş ve "ah sıcak!" der gibi elini çekiyor. Bilgisayarın etrafında pembe-turuncu ısı dalgaları görünüyor. Yonga masanın köşesinde, meraklı gözlerle Bilge'nin yüzüne bakıyor. Sıcak sarı ve turuncu tonlar; ev ortamının sıcaklığı ve merak hissi.

---

## Sayfa 2 — Transistörler Çalışırken

**Metin:**
Yonga açıkladı: {Y}"Bir yonganın içinde milyarlarca transistör var, hepsini hatırlıyor musun?" Bilge başını salladı. {Y}"Her transistör çalışırken biraz enerji harcar. Bu enerji ısıya dönüşür!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Yonga büyük bir hologram açıyor; içinde minicik transistörler çalışıyor ve her birinin üzerinden küçük kırmızı-turuncu ısı dalgacıkları yükseliyor. Bilge hologramı inceliyor, parmağıyla transistörlerin üzerinden geçmeye çalışıyor. Hologram ısıyla biraz titriyor. Turuncu, kırmızı ve altın tonlar; enerji ve ısı görsel metaforuyla işleniyor.
...
## Sayfa 5 — Pervaneler Neden Üfler?

**Metin:**
{B}"Peki bilgisayarın içindeki pervane ne için var?" diye sordu Bilge. Yonga güldü: {Y}"Pervane, bilgisayarı serinletmek için! Isıyı dışarı atar." Bilge düşündü: {B}"Bilgisayar da yelpaze kullanıyor!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bilgisayarın içi yarısaydam gösterilmiş; ortada dönen büyük bir pervane var. Pervane döndükçe kırmızı-turuncu ısı dalgaları bilgisayarın çıkışına doğru itiliyor, soğuk mavi hava içeriye çekiliyor. Bilge bilgisayarın yanında, elini pervanenin hava çıkışına yaklaştırmış — sıcak hava elini ısıtıyor. Yonga açıklama yapıyor. Kırmızı-turuncu ile mavi renk çatışması; ısı ve soğutma dinamiği.
...
## Sayfa 7 — Isı Denetimden Çıkıyordu

**Metin:**
{Y}"Bir zamanlar bilgisayar yongaları o kadar ısındı ki üzerinde yumurta pişirebilirdin!" dedi Yonga. Bilge güldü ama endişelendi: {B}"Bu tehlikeli değil mi?"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Eğlenceli abartılmış bir sahne: kızgın bir işlemci yonga üzerinde biri gerçekten tavada yumurta pişiriyor gibi görünüyor — yumurta kızarıyor, altından buhar çıkıyor. Yonga bu abartılmış sahneyi hologramda gösterirken küçük elleriyle "abartıyorum tabi!" der gibi el sallıyor. Bilge hem gülerek hem de "vay be" ifadesiyle bakıyor. Turuncu, kırmızı ve sarı tonlar; eğlenceli ama öğretici.
...
## Sayfa 11 — Telefonlar Çok Dikkatli

**Metin:**
{Y}"Telefonlar bilgisayarlara göre çok daha dikkatli!" dedi Yonga. {Y}"Pil biterse telefon çalışmaz. Bu yüzden telefon yongaları enerjiyi çok verimli kullanır." Bilge onayladı: {B}"Pil simgesi kırmızıya dönünce ben de paniklerim!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bilge elinde telefonuyla — ekranda kırmızı pil ikonu yanıp sönüyor. Yüzünde komik panik ifadesi var. Yonga ise hologramda telefon işlemcisini gösteriyor; işlemci özenle her görevi ölçüp biçiyor, israfı önlemek için minyatür terazi kullanıyor. Kırmızı panik rengi ile yeşil tasarruf rengi; enerji yönetiminin önemi eğlenceli şekilde vurgulanmış.
...
## Sayfa 14 — Her Güç Bir Sorumluluk

**Metin:**
Bilge dedi ki: {B}"Demek bilgisayar ne kadar güçlü olursa, enerjiyi o kadar dikkatli kullanması gerekiyor." Yonga başını salladı: {Y}"Ve mühendislerin görevi bu dengeyi bulmak!"

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bilge ve Yonga akşam ışığında pencere kenarında oturmuş, birlikte bir bilgisayarı inceliyorlar. Bilgisayarın ekranında güç ve soğutma sembolleri dengeli bir terazi üzerinde görünüyor. Dışarıda gün batımı var — turuncu-kırmızı gökyüzü, bilgisayarın ısısını andırır gibi, ama sakin. İçten, öğretici ve umut verici son sahne; altın, turuncu ve mavi tonlar.
...
❄️ Mühendisler bu sorunu çözmek için **daha az gerilim** ve **çok çekirdek** tasarımı kullandılar.
