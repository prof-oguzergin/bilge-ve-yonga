...
**Seri:** Bilgisayar Mimarisi Serisi — Alt Seri 2: Hız ve Güç — Kitap 2.6
**Yaş grubu:** 7–10 (okuma bilen)
**Ana tema:** Sınama programları (benchmark): bilgisayarları adil biçimde karşılaştırma
...
## Sayfa 2 — Hayali Yarış Pisti

**Metin:**
Yonga, Bilge'nin kulaklığına fısıldadı: {Y}"Hayal et: büyük bir yarış pistimiz var." Gözlerini kapayan Bilge, zihninde koskoca bir pist gördü: çimenli kenarlar, renk renk bayraklar ve pistin önünde bekleyen üç farklı araba. {Y}"Her araba bir bilgisayar!" dedi Yonga neşeyle.

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Bilge gözlerini kapatmış, başının üstünde rüya baloncuğu beliriyor. Balonun içinde güneşli bir yarış pisti: yeşil çimenler, renkli bayraklar ve üç farklı araba: biri kırmızı ve sportif, biri mavi ve büyük, biri sarı ve küçük. Yonga Bilge'nin omzuna konmuş, gözlerinden heyecan ışıkları çıkıyor.
...
## Sayfa 4 — Üç Farklı Araba

**Metin:**
Pistin başına geldiler. Kırmızı araba çok çevik görünüyordu, mavi araba büyük ama güçlüydü, sarı araba ise küçücüktü. {B}"Hangi araba kazanır?" diye sordu Bilge. {Y}"Bu, hangi yolu koşturduğuna bağlıdır!" dedi Yonga. {Y}"Bilgisayarlar için de böyledir, hangi işi yaptırdığına bağlıdır."

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Üç renkli araba bir start çizgisinde dizilmiş: sağda kırmızı sportif araba, ortada mavi büyük araba, solda sarı minik araba. Bilge ve Yonga kenardan heyecanla izliyor. Her arabanın üstünde küçük ekranlar var: gerçek bilgisayarları temsil ettiğini gösteren ikon lambalar yanıp sönüyor.
...
## Sayfa 7 — Yapay Zeka Yarışı

**Metin:**
"Üçüncü yarış: Yapay zeka!" duyurusu yankılandı. Pist boyunca küçük robot simgeleri ve beyin şekilleri dizildi. Bu kez sarı küçük araba öne fırladı ve birinci oldu! {B}"Küçük ama güçlü!" diye güldü Bilge. Yonga açıkladı: {Y}"Bazı bilgisayarlar küçüktür ama yapay zeka işleri için özel olarak tasarlanmıştır."

**Resim:**
Sıcak renkli, yumuşak çizgili, dijital suluboya tarzında çocuk kitabı illüstrasyonu. Pist kenarlarında küçük robot figürleri ve pembe beyin simgeleri asılı. Sarı küçük araba birinci olarak bitiş çizgisini geçiyor, konfeti yağıyor. Kırmızı araba ikinci, mavi üçüncü. Bilge neşeyle gülüyor, Yonga küçük kollarını zafer işareti yapıyor.
...
🏁 Bir bilgisayarın hızını ölçmek için ona gerçek işler yaptırırız. Buna **sınama programı** (benchmark) diyoruz.

⚖️ Farklı bilgisayarları adil karşılaştırmak için hepsine **aynı sınamayı** uygulamak gerekir, tıpkı arabaların aynı parkurda yarışması gibi.

💻 **SPEC**, bilgisayarları adil karşılaştırmak için sınama programları hazırlayan bir kuruluştur.

🔢 Hesaplama sınaması, 🎨 grafik sınaması, 🤖 yapay zeka sınaması gibi **farklı iş yükleri** için ayrı sınamalar vardır.
